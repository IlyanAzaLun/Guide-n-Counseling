...
<div class="modal fade" id="modal-import-teacher" tabindex="-1" role="dialog" aria-labelledby="modal-teacher" aria-hidden="true">
  ...
  <!-- delete teacher -->
  <div class="modal fade" id="modal-conformation-delete" tabindex="-1" role="dialog" aria-labelledby="modal-teacher" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="modal-teacher">Empty data teacher</h5>
        ...
        <form action="<?=BASEURL?>/teacher/delete" method="POST" role="form" enctype="multipart/form-data">
          <div class="modal-body">
